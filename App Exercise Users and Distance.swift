...
var yourName = User(name: "Deemh", age: 23, height: 170.0, weight:60 , activityLevel: 5)
print("my name is \(yourName.name), I am \(yourName.age) years old, my height \(yourName.height) cm and my weight \(yourName.weight)kg, my activity level is \(yourName.activityLevel)) ")
...
var antherDis = Distance(feet: 27)
print(antherDis.meters)